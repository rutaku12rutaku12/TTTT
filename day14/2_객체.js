...
// const person = { name: '이름', age: '나이', city: '사는 곳'};
// console.log(person);
...
//   pages: 500
// };
// 1. 객체내 모든 값 반환 (배열) 반환 : Object.valuse( 변수명 )
...
// 예제 9: 객체와 조건문 활용하기
// 다음 inventory 객체는 각 상품의 재고를 나타냅니다. for 반복문과 if 조건문을 사용하여 
// 재고가 10개 미만인 상품의 이름을 콘솔에 출력하시오.
// const inventory = {
//   apple: 15,
//   banana: 5,
//   orange: 20,
...
// for( let index = 0 ; index <=Object.keys(inventory).length-1; index++){
//     const key = names[index]; // index번째의 속성/key명 호출
//     if( inventory[key] < 10) {// 만약에 inddex 번째 속성/key명 값 의 10 미만 이면
//         console.log(key);
//     }
// }
...
// for(i=0; i<=Object.keys(inventory).length-1; i++){
//     const key = names[i]
//     if( inventory[key] < 10){console.log(key)}
...
// const data = response.data; // 실제 데이터가 있는속성
//     console.log(data);
// let html =`<table>
//                 <tr>
