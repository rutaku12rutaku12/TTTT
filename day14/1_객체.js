...
console.log(obj2);  // {속셩명1: 10, 속성명2: 'hello'}
...
// * 반복문 : 변수에 가지(참조)는 정보를 찾아가기(껍질까지)
// 제품목록(변수) -> 요소(배열) -> 속성값(객체) , **변수명[인덱스].속성명**
for( let i = 0; i <= 제품목록.length-1; i++){
    const product = 제품목록[i]; // i번째의 제품(객체)
    console.log( product.제품명); // i번째의 제품(객체) 의 속성값 호출
