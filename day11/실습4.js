...
let 화씨온도 = Number( 섭씨온도 * 9 / 5 ) + Number(32);
console.log( 화씨온도 );
 */
...
/* let 출생년도 = prompt(" 태어난 년도 : ");
let 현재나이 = Number(2025)-Number(출생년도);
console.log(현재나이); */
...
/* let 아이디 = prompt( " 아이디 : ");
let 이메일 = prompt( " 이메일 : ");
let 결과 = 아이디 == 'admin' || 이메일 == 'admin@test.com' ? '관리자' : '일반 사용자';
console.log(결과); */
...
/* let 나이 = prompt(" 나이 : ");
let 결과 = (나이>=20 && 나이 <=29) ? "이벤트 대상입니다." : "이벤트 대상이 아닙니다.";
console.log(`${결과}`); */
...
console.lig( todoList); // 배열 전체 요소 출력 */
