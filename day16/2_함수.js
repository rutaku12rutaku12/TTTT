...
// console.log(지역변수1); // fail : 현 위치는 인천광역시 호출[x]
// console.log(지역변수2); // fail : 현 위치는 부평구 호출[x]

// [7] 생각해보기 : 이름을 입력받아 배열 저장하는 함수
let nameList = []
function nameAdd( ){
    let name = prompt('이름 : ');
    nameList.push(name);
...
// 현재 코드흐름이 변수는 총 몇개일까요? nameList 1개
    // vs
let nameList2 = []
let name1 = prompt('이름: ');
nameList.push( name1 );
...
// 현재 코드흐름이 변수는 총 몇개일까요? nameList , name1, name2 3개
