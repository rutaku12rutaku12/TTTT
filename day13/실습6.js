...
//     // index 0부터 마지막인덱스 이하까지 1씩증가.
//     if(max <numbers[index]){ max = numbers[index];}
//     // 만약에 max 보다 index번째 요소값이 더크면 max에 index 요소값을 대입한다.
//     // for end
// }
// console.log(max)
...
/* 
            ...
            ****        1           1 2 3 4 5      1 ~ (전체줄수 - 현재 줄수) 3+1
            ***         1           1 2 3 4 5      1 ~ (전체줄수 - 현재 줄수) 2+1
            **          1           1 2 3 4 5      1 ~ (전체줄수 - 현재 줄수) 1+1
            *           1           1 2 3 4 5      1 ~ (전체줄수 - 현재 줄수) 0+1
            
            line은 1부터 5까지 1씩증가  -> for ( let line = 1; line<= 5 ; line++)
            star은 1부터 5/4/3/2/1/까지 증가 ->for( let star = 1 ; <= 54321; star<=5-line+1 ; star++)
*/
...
// 문자 : 문자1개 <아스키코드/유니코드> , 문자열 : 문자 여러개 <배열>
// C언어 : let 이름 = ['김', '하', '준']
...
// let 행1 = seatLayout[0]
//     console.log( 행1[0]); // A1 / 0,0
//     console.log( 행1[1]); // A2 / 0,1
//     console.log( 행1[2]); // A3 / 0,2
// let 행2 = seatLayout[1]
//     console.log( 행2[0]); // B1 / 1,0
//     console.log( 행2[1]); // B2 / 1,1
//     console.log( 행2[2]); // B3 / 1,2
// let 행3 = seatLayout[2]
//     console.log( 행3[0]); // C1 / 2,0
//     console.log( 행3[1]); // C2 / 2,1
//     console.log( 행3[2]); // C3 / 2,2
//     // for ( let index = 0 ; <= row.length-1 ; index++){}
...
//     let seat = seatStatus[index]; // index 번째의 좌석 호출
//     if( seat == "빈좌석"){document.write(`<span style="color:blue">빈좌석</span>`);
//     }else{document.write(`<span style="color:red">예약석</span>`);}
//     //
