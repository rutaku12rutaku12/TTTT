...
// p.519
// 1. 자동 형 변환
    // (1) 문자열형의 숫자( "5" )에 곱하기 1를 하면 문자열형의 숫자( 5 )가 숫자열 숫자로 변환한다. 
let input = prompt("숫자를 입력하세요.")        // 숫자 5 를 넣어도 prompt 함수는 항상 문자열 반환한다.
    // let imput = "5"
...
// 생각해보기1 : 국어 점수 와 수학 점수를 prompt 로 입력받아 국어점수 와 수학점수를 더한 결과를 console.log 출력하시오.
    ...
    //prompt("수학점수를 입력하세요.")
    //(2) 저장하기 ,변수
    let 국어점수 = prompt("국어점수를 입력하세요.")       // "10"
    let 수학점수 = prompt("수학점수를 입력하세요.")       // "20"
    //(3) 처리하기, 연산
